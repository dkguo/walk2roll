...
void loop() {
  ...
  switch (state) {
    ...
    case 1:
      front_des = 1500;
      back_des = 1500;
      if (back_pos > 1400 && front_pos > 1400)
        state = 2;
      break;
...
//      front_des = 0;
//      back_des = 0;
//      if (front_pos > -50 && front_pos < 50 && acc_y > -0.06 && acc_y < 0.15 && acc_z > 1)
//        state = 0; // probably state 7
//      else if (front_pos > -50 && front_pos < 50)
//        state = 4;
//      break;
//
//    case 6:
...
//      front_des = 0;
//      back_des = 0;
//      if (back_pos < 50 && acc_y > 0.2 && acc_z > 0.9)
//        state = 3;
//      break;
  }
